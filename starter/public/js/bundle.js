...
var signupBtn = document.querySelector('.signup-form .form');
var loginBtn = document.querySelector('.login-form .form');
...
if (signupBtn) signupBtn.addEventListener('submit', function (event) {
...
if (loginBtn) loginBtn.addEventListener('submit', function (event) {
  console.log("Form submitted");
  event.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
...
},{"./login":"login.js","./leaflet":"leaflet.js","./updateSettings":"updateSettings.js","./signUp":"signUp.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
